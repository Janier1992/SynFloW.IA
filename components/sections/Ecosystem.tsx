            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        >
                            Medellín presenta un entorno favorable para SynFlow, con una notable concentración de centros de innovación tecnológica. La ciudad cuenta con hubs clave como Ruta N, el Centro para la Cuarta Revolución Industrial y una vibrante comunidad de coworking y empresas de software.
                        </motion.p>
