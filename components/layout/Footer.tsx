            ...
            case 'about':
                return {
                    ...
                    content: (
                        <>
                            <p className="mb-4">
                                Somos <strong>SinFlow</strong>, una agencia de soluciones tecnológicas dedicada al desarrollo de aplicaciones web y móviles, enfocada especialmente en el sector PYMES.
                            </p>
                            <p>
            ...
            case 'privacy':
                return {
                    ...
                    content: (
                        <>
                            <p className="mb-4">
                                En <strong>SinFlow</strong>, respetamos y aseguramos la privacidad de los datos personales de nuestros usuarios. Nos comprometemos a garantizar que cualquier información recopilada sea utilizada de manera responsable, transparente y segura.
                            </p>
            ...
            case 'terms':
                return {
                    ...
                    content: (
                        <>
                            <p className="mb-4">
                                Al acceder y utilizar los servicios de <strong>SinFlow</strong>, aceptas cumplir con los siguientes términos y condiciones de uso, los cuales rigen la relación entre la agencia y el cliente bajo las leyes de la República de Colombia.
                            </p>
                            <ul className="list-disc pl-5 space-y-2 mb-4">
                                <li><strong>Uso de la Plataforma:</strong> El usuario se compromete a usar nuestros servicios de manera lícita y ética.</li>
                                <li><strong>Propiedad Intelectual:</strong> Todo el código, diseño y contenido desarrollado por SinFlow es propiedad intelectual protegida, salvo acuerdo contrario por contrato.</li>
                                ...
                                <li><strong>Responsabilidad:</strong> SinFlow no se hace responsable por el uso indebido de las soluciones entregadas una vez finalizado el soporte.</li>
                            </ul>
                        </>
                    )
                };
